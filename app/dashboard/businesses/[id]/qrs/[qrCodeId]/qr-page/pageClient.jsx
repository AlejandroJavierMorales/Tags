...

            {
                activeTab === "header" && (
                    <div className="qr_page_card">
                        ...
                        <p className="qr_page_help">
                            Configuración general del encabezado, menú y tipografías.
                        </p>
            ...
            }
            {
                activeTab === "footer" && (
                    <div className="qr_page_card">
                        ...
                        <p className="qr_page_help">
                            Configuración general del Pie de Página y tipografías.
                        </p>
