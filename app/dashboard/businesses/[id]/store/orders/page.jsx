// =====================================
// PAGE: /dashboard/businesses/[id]/store/orders
// Descripción: Listado de pedidos de Tags Tienda.
...
import StoreOrdersClient from "./pageClient";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export const metadata = {
    title: "Pedidos | Tags Tienda",
    robots: {
        index: false,
        follow: false
    }
