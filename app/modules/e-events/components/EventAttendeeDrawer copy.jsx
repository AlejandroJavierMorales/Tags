                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span className="tags_badge">
                                                Permitidos:
                                                {" "}
                                                {form.plus_ones_allowed || 0}
                                            </span>

                                            <span className="tags_badge_success">
                                                Confirmados:
                                                {" "}
                                                {attendee.companions?.filter(
                                                    c =>
                                    ...
                                    {/* LIST */}
                                    {
                                        ...
                                        (
                                            ...
                                            >
                                                ...
                                                {
                                                    attendee.companions.map(companion => (
