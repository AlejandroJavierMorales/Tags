...
export default function StoreBlockEditor({
    ...
    function renderSelectField({ field, value }) {
        return (
            ...
            >
                <option value="">
                    {field.emptyLabel || "Elegir opción"}
                </option>
                        ...
                        onClick={async () => {
                            const result =
                                await showAlert({
                                    ...
                                    text: "Se eliminarán todas las personalizaciones del bloque y volverá a su configuración por defecto.",
                                    icon: "warning",
